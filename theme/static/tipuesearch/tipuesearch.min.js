...
{out+='<div class="card card-body my-2 tipue_search_result">';out+='<div class="h5 card-title tipue_search_content_title"><a class="text-dark" href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></div>';if(set.debug)
