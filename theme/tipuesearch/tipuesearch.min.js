...
if(c==1)
{out+='<div class="mx-2" id="tipue_search_results_count">'+tipuesearch_string_4;}
else
{var c_c=c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",");out+='<div class="mx-2" id="tipue_search_results_count">'+c_c+' '+tipuesearch_string_5;}
if(set.showTime)
...
{out+='<div class="card card-body my-2 tipue_search_result">';out+='<div class="h5 card-title tipue_search_content_title"><a class="text-dark" href="'+found[i].url+'#:~:text='+getURLP('q')+'"'+tipue_search_w+'>'+found[i].title+'</a></div>';if(set.debug)
{out+='<div class="tipue_search_content_debug">Score: '+found[i].score+'</div>';}
if(set.showURL)
{var s_u=found[i].url.toLowerCase();if(s_u.indexOf('http://')==0)
{s_u=s_u.slice(7);}
out+='<div hidden class="tipue_search_content_url"><a href="'+found[i].url+'"'+tipue_search_w+'>'+s_u+'</a></div>';}
if(found[i].img)
{if(set.imageZoom)
